...
def list_test_4():
    '''Given the list x, and list y, assign indices of list x 2 - 11, the values of list y! Hint: Use the row operator for lists!
...
def dict_test_2():
    '''Given dict animal_noises, assign y the value at the key "cat" '''
    animal_noises = {
        "dog" : "bark",
        "cow" : "moo",
        "cat" : "meow",
